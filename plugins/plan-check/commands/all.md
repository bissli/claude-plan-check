---
description: Validate a plan using 4 parallel specialized agents with full synthesis
---

# Plan Check: Full Validation

Validate an implementation plan for gaps, code impact, risks, and checklist quality.
...
## Step 3: Parallel Validation (4 Sonnet agents)
...
4. **checklist-architect** (CHK prefix): Evaluate the plan's implementation checklist for structure, completeness, item quality, and missing phases. Always produce a complete proposed checklist as output, even if the plan already has one.
